...
function setup_environment {
  ...
  URL="https://www.tu-ilmenau.de/unirz/it-service-desk/"
  SUPPORT="1111@tu-ilmenau.de"
if [ ! -z "$DISPLAY" ] ; then
...
if ! ask "Dieses Installationsprogramm funktioniert nur für Anwender von ${bf}Technische Universität Ilmenau.${n}" "Weiter" 1 ; then exit; fi
...
class EduroamNMConfigTool:
    ...
    def add_connection(self,ssid):
        server_alt_subject_name_list = dbus.Array({'DNS:radius.tu-ilmenau.de'})
        server_name = 'radius.tu-ilmenau.de'
        if self.nm_version == "0.9" or self.nm_version == "1.0":
        ...
        s_8021x = dbus.Dictionary({
            ...
            'anonymous-identity': 'anonymous@tu-ilmenau.de',
        })
...
network={
  ...
  identity="${USER_NAME}"
  domain_suffix_match="radius.tu-ilmenau.de"
  phase2="auth=MSCHAPV2"
  password="${PASSWORD}"
