...
install-mue-p14s:
	stow --no-folding --restow -v -t $$HOME i3-p14s sway-p14s hypr-p14s kanshi-p14s shikane

delete-mue-p14s:
	stow --no-folding -v -t $$HOME --delete i3-p14s sway-p14s hypr-p14s kanshi-p14s shikane
...
install-t480:
	stow --no-folding --restow -v -t $$HOME i3-t480 sway-t480 hypr-t480 kanshi-t480 shikane
	stow --no-folding --restow -v -t $$HOME i3status-rust

delete-t480:
	stow --no-folding -v -t $$HOME --delete i3-t480 sway-t480 hypr-t480 kanshi-t480 shikane
