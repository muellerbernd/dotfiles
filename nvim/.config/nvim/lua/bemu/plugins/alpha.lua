...
dashboard.section.buttons.val = {
  ...
  dashboard.button('p', '  My-Wikis', "<cmd>lua require('bemu.telescope.funcs').list_mywikis() <CR>"),
  dashboard.button('r', '  Recently used files', ':Telescope oldfiles <CR>'),
  dashboard.button('t', '  Find text', ':Telescope live_grep <CR>'),
  dashboard.button('c', '  Configuration', "<cmd>lua require('bemu.telescope.funcs').edit_neovim() <CR>"),
