...
text("TEXT HERE")
  ...
  markdown = {
    ...
    snip({ trig = 'link', name = 'markdown link' }, {
      text '[',
      insert(1),
      text '](',
  ...
  tex = {
    ...
    snip({ trig = 'glq', name = "'", dscr = 'German left single quotes' }, { text '\\glq{}' }),
    snip({ trig = 'grq', name = "'", dscr = 'German right single quotes' }, { text '\\grq{}' }),
    snip({ trig = 'glqq', name = '"', dscr = 'German left double quotes' }, { text '\\glqq{}' }),
    snip({ trig = 'grqq', name = '"', dscr = 'German right double quotes' }, { text '\\grqq{}' }),
    snip({
      trig = 'q',
      name = "'TEXT HERE'",
      dscr = 'German single quote environment',
    }, { text '\\glq{}', insert(0, 'Text here'), text '\\grq{}' }),
    snip({
      trig = 'qq',
      name = '"TEXT HERE"',
      dscr = 'German double quote environment',
    }, { text '\\glqq{}', insert(0, 'Text here'), text '\\grqq{}' }),
    snip({ trig = 'fn', name = 'footnote', dscr = '\\footnote{}' }, { text '\\footnote{', insert(0), text '}' }),
  },
}
